...
\end{enumerate}
%Now, we can assume the following: \eq{(\forall{A,B}\subset\F)(\exists{c}\in\F)(\forall{a}\in{A})(\forall{b}\in{B})(a\leq{b})(a\leq{c}\leq{b})}
%And we need to show that there exists an infimum for every non-empty set that is bounded from below.\\
